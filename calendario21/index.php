...
if (isset($_POST['from'])) 
{
    ...
    if ($_POST['from']!="" AND $_POST['to']!="") 
    {
        ...
        $ambientea = evaluar($_POST['ambientea']);
        ...
        if (!empty($_GET['id'])) {
            $id = $_GET['id'];
                    ...
                    //validacion2
                      ...
                      $query="INSERT INTO eventos VALUES(null,'$centro','','','$ambientea','$instructora','$area','$ficha','$especialidad','$titulo','','','$clase','$inicio','$final','$inicio_normal','$final_normal')";             
                       ...
                       if($xYear == $yYear  ){
                            if($xMonth <= $yMonth ) {
                                ...
                                $final4  = _formatear($_POST['to']);                    
                                 ...
                                 $query="INSERT INTO eventos VALUES(null,'$centro','','','$ambientea','$instructora','$area','$ficha','$especialidad','$titulo','','','$clase','$inicio4','$final4','$inicio_normal','$final_normal')";
                                 ...
                                 $link = "http://localhost/yaneth/programacion_trimestral/calendario21/"."descripcion_evento.php?id=$id";
                                 ...
                                 header("Location:http://localhost/yaneth/programacion_trimestral/calendario21?men=ver&&id=$id"); 
                                    ...
                                    $row = $im->fetch_row();  
                                    $id = trim($row[0]);
                                    header("Location:http://localhost/yaneth/programacion_trimestral/calendario21?men=fal12&&id=$id");
                                     ...
                                     $row = $im->fetch_row();  
                                     $id = trim($row[0]);
                                     header("Location:http://localhost/yaneth/programacion_trimestral/calendario21?men=fal2&&id=$id");
