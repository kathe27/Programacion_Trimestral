        ...
        if (!empty($_GET['id'])) {
         ...
         $conexion = mysqli_connect("localhost","root","","programacion_trimestral");  
                    ...
                    // insertamos el evento
                     ...
                     $link = "http://localhost/yaneth/programacion_trimestral/calendario11/"."descripcion_evento.php?id=$id";
                     ...
                     header("Location:http://localhost/yaneth/programacion_trimestral/calendario11?men=ver&&id=$id1"); 
                    }else{
                     $conexion->query($query); 
                     $im=$conexion->query("SELECT MAX(id) AS id FROM eventos");
                     $row = $im->fetch_row();  
                     $id = trim($row[0]);
                     header("Location:http://localhost/yaneth/programacion_trimestral/calendario11?men=fal&&id=$id1");
                    }
