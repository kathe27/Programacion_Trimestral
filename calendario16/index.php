                       ...
                       if($xYear == $yYear  ){
                            if($xMonth <= $yMonth ) {
                                ...
                                $final4  = _formatear($_POST['to']);                    
                                 ...
                                 $link = "http://localhost/yaneth/programacion_trimestral/calendario16/"."descripcion_evento.php?id=$id";
                                 ...
                                 header("Location:http://localhost/yaneth/programacion_trimestral/calendario16?men=ver&&id=$id"); 
                                    ...
                                    $row = $im->fetch_row();  
                                    $id = trim($row[0]);
                                    header("Location:http://localhost/yaneth/programacion_trimestral/calendario16?men=fal12&&id=$id");
                                     ...
                                     $row = $im->fetch_row();  
                                     $id = trim($row[0]);
                                     header("Location:http://localhost/yaneth/programacion_trimestral/calendario16?men=fal2&&id=$id");
